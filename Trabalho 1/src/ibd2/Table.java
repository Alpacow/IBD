...
public abstract class Table {
    ...
    //header
    public final static Long INDEX_LEN = Long.BYTES + 3 * BLOCKS_AMOUNT * Block.RECORDS_AMOUNT * Long.BYTES; // 47.624
    public final static Long FREE_BLOCKS_LEN = Long.BYTES + BLOCKS_AMOUNT * Long.BYTES; // 520
    private final static Long HEADER_LEN_AUX = INDEX_LEN + FREE_BLOCKS_LEN; // 48.144
    public final static Long FILLER = (4L * 1024) - (HEADER_LEN_AUX % (4L * 1024));
    public final static Long HEADER_LEN = HEADER_LEN_AUX + FILLER; 
