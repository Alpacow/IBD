...
public class Block implements Iterable {
    ...
    public final static Long RECORDS_AMOUNT = 31L; // 31
    
    public final static Long HEADER_LEN = Long.BYTES + RECORDS_AMOUNT * Long.BYTES; // 256
    
    private final static Long BLOCK_LEN_AUX = HEADER_LEN + RECORDS_AMOUNT * Record.RECORD_SIZE; // 32.744
     
    public final static Long FILLER = (4L * 1024) - (BLOCK_LEN_AUX % (4L * 1024));
    
    public final static Long BLOCK_LEN = BLOCK_LEN_AUX + FILLER; 
